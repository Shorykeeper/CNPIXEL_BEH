...
from ..listen.event import BaseEvent
from ..config.modConfig import *
from ..listen.listen import Listen, EventPriority
from mod_log import logger

ListenDict = {Listen.minecraft: ("Minecraft", "Engine"), Listen.client: (modName, "main"),
...
class BaseModule(object):
    ...
    def listen(self, event, func, _type=Listen.minecraft, priority=EventPriority.NORMAL):
        if _type not in ListenDict:
            return
        name, system = ListenDict[_type]
